export default function CustomPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-14">
      ...
      <div className="bg-white rounded-2xl p-10 mb-10 border border-hb-200/40 shadow-sm">
        <h2 className="font-display text-3xl font-bold text-hb-900 mb-8">
          How it works
        </h2>
        <div className="space-y-8 font-body">
          <div className="flex gap-5">
            <div className="w-12 h-12 bg-gradient-to-br from-coral to-coral-light text-white rounded-xl flex items-center justify-center font-bold text-lg shrink-0 shadow-sm">
              1
            </div>
            <div>
              <h3 className="font-bold text-hb-900 text-lg">Tell us what you need</h3>
              <p className="text-text/50 mt-1 leading-relaxed">
          ...
          <div className="flex gap-5">
            <div className="w-12 h-12 bg-gradient-to-br from-hb-500 to-hb-300 text-white rounded-xl flex items-center justify-center font-bold text-lg shrink-0 shadow-sm">
              2
            </div>
            <div>
              <h3 className="font-bold text-hb-900 text-lg">We confirm details</h3>
              <p className="text-text/50 mt-1 leading-relaxed">
          ...
          <div className="flex gap-5">
            <div className="w-12 h-12 bg-gradient-to-br from-green to-green-light text-white rounded-xl flex items-center justify-center font-bold text-lg shrink-0 shadow-sm">
              3
            </div>
            <div>
              <h3 className="font-bold text-hb-900 text-lg">Confirm and pickup</h3>
              <p className="text-text/50 mt-1 leading-relaxed">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        <div className="bg-white rounded-2xl p-7 border border-hb-200/30 shadow-sm hover:shadow-md transition-shadow">
          <div className="w-10 h-10 bg-coral/10 rounded-lg flex items-center justify-center mb-4">
            <span className="text-xl">🎂</span>
          </div>
          <h3 className="font-body font-bold text-hb-900 text-lg mb-2">
            Birthday cakes
          </h3>
        ...
        <div className="bg-white rounded-2xl p-7 border border-hb-200/30 shadow-sm hover:shadow-md transition-shadow">
          <div className="w-10 h-10 bg-hb-500/10 rounded-lg flex items-center justify-center mb-4">
            <span className="text-xl">📦</span>
          </div>
          <h3 className="font-body font-bold text-hb-900 text-lg mb-2">
            Office and events
      ...
      <div className="text-center bg-gradient-to-br from-hb-100/50 to-cream-100 rounded-2xl p-10 border border-hb-200/40">
        <h3 className="font-display text-2xl font-bold text-hb-900 mb-3">
          Ready to start?
        </h3>
        <p className="text-text/50 font-body mb-3 text-lg">
